"""
Backward greedy IoU linking with track-length confidence boosts; no gap filling.

GT-free version of backward_iou/postprocess.py. See this folder's README for differences.
...
RESULTS_DIR = Path(r"D:\cw_rf_detr_dataset_raw\tracking_inference\backward_iou")
RESOLUTION = 512
