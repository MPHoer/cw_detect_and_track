"""
Forward Trackpy linking, gap filling, and nearby new-ID continuation merging.

GT-free version of forward_trackpy/pp_fill_holes_static_switch.py. See this folder's README for differences.
...
RESULTS_DIR = Path(r"D:\cw_rf_detr_dataset_raw\tracking_inference\trackpy_static_switch")
RESOLUTION = 512
